...
var Pointer = /** @class */ (function () {
    ...
    Object.defineProperty(Pointer.prototype, "velocityX", {
        get: function () {
            return this.velocitiesX.length &&
                this.pointerify.config.behavior.allowAxis !== axis_1.default.Y
                ? this.velocitiesX.reduce(function (value, sum) { return value + sum; }, 0) /
                    this.velocitiesX.length
                : 0;
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(Pointer.prototype, "velocityY", {
        get: function () {
            return this.velocitiesY.length &&
                this.pointerify.config.behavior.allowAxis !== axis_1.default.X
                ? this.velocitiesY.reduce(function (value, sum) { return value + sum; }, 0) /
                    this.velocitiesY.length
                : 0;
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(Pointer.prototype, "deltaX", {
        get: function () {
            return this.pointerify.config.behavior.allowAxis === axis_1.default.Y
                ? 0
    ...
    Object.defineProperty(Pointer.prototype, "deltaY", {
        get: function () {
            return this.pointerify.config.behavior.allowAxis === axis_1.default.X
                ? 0
    ...
    Object.defineProperty(Pointer.prototype, "velocityPinch", {
        get: function () {
            return this.velocitiesPinch.length
                ? this.velocitiesPinch.reduce(function (value, sum) { return value + sum; }, 0) /
                    this.velocitiesPinch.length
                : 0;
        },
        enumerable: true,
        configurable: true
    ...
    Pointer.prototype.getState = function () {
        ...
        state.multiplierX = clampX
            ? clamp_1.default(this.multiplierX, 0, 1)
            : this.multiplierX;
        state.multiplierY = clampY
            ? clamp_1.default(this.multiplierY, 0, 1)
            : this.multiplierY;
